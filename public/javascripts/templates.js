...
Templates.EditTrack = '<h2>Pin a new track or playlist to your memory map</h2><form class="track"><input type="text" value="Search"/></form>';
...
Templates.EditLocation = '<div class="page-bottom"><form><span class="mp-location"></span><input type="text" /></form></div>';
Templates.EditDescription = '';
Templates.Pagination = '<div class="pagination"><div class="left"><button class="sp-button mp-dark">Cancel</button></div><div class="right"><button class="sp-button sp-icon mp-icon"><span class="mp-arrowright"></span>Next</button></div></div>';
